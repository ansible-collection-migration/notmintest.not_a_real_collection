...
from ansible_collections.notmintest.not_a_real_collection.tests.unit.compat import mock, unittest
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.gcp import (_get_gcp_ansible_credentials, _get_gcp_credentials, _get_gcp_environ_var,
...
class GCPAuthTestCase(unittest.TestCase):
    ...
    def test_validate_credentials_file(self):
        ...
        # of this function
        module = FakeModule()
        with mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.gcp.open',
    ...
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.gcp._get_gcp_environ_var',
