...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.device import FtdPlatformFactory, FtdModel, FtdAsa5500xPlatform, \
    Ftd2100Platform, AbstractFtdPlatform
from ansible_collections.notmintest.not_a_real_collection.tests.unit.modules.network.ftd.test_ftd_install import DEFAULT_MODULE_PARAMS
...
class TestFtdPlatformFactory(object):
    ...
    def mock_devices(self, mocker):
        mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.device.Kp')
        mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.device.Ftd5500x')
...
class TestFtd2100Platform(object):
    ...
    def kp_mock(self, mocker):
        return mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.device.Kp')
...
class TestFtdAsa5500xPlatform(object):
    ...
    def asa5500x_mock(self, mocker):
        return mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.device.Ftd5500x')
