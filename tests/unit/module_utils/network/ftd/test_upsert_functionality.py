...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.common import FtdServerError, HTTPMethod, ResponseParams, FtdConfigurationError
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.configuration import DUPLICATE_NAME_ERROR_MESSAGE, UNPROCESSABLE_ENTITY_STATUS, \
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.fdm_swagger_client import ValidationError
...
class TestUpsertOperationUnitTests(unittest.TestCase):
    ...
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.configuration.copy_identity_properties')
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.configuration._set_default')
    ...
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.configuration.OperationChecker.is_upsert_operation_supported')
    ...
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.configuration.equal_objects')
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.configuration.OperationChecker.is_upsert_operation_supported')
    @mock.patch.object(BaseConfigurationResource, "get_operation_specs_by_model_name")
    @mock.patch.object(BaseConfigurationResource, "_find_object_matching_params")
    @mock.patch.object(BaseConfigurationResource, "_add_upserted_object")
...
class TestUpsertOperationFunctionalTests(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ftd_configuration.Connection')
