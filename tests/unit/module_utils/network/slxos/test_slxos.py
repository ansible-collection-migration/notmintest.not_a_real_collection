...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.slxos import slxos
...
class TestPluginCLIConfSLXOS(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.slxos.slxos.Connection')
