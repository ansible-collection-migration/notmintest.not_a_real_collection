...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp import NetAppESeriesModule, create_multipart_formdata
...
class NetappTest(ModuleTestCase):
    REQUIRED_PARAMS = {"api_username": "rw",
                       ...
                       "ssid": "1"}
    REQ_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.request'
