...
def XenAPI():
    ...
    fake_xenapi = importlib.import_module('ansible_collections.notmintest.not_a_real_collection.tests.unit.module_utils.xenserver.FakeXenAPI')
...
def xenserver(XenAPI):
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils import xenserver
