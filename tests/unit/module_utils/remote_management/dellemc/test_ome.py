...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.remote_management.dellemc.ome import RestOME
...
class TestRestOME(object):
    ...
    def test_invoke_request_with_session(self, mock_response, mocker):
        mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.remote_management.dellemc.ome.open_url',
    ...
    def test_invoke_request_error_case_handling(self, exc, mock_response, mocker):
        open_url_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.remote_management.dellemc.ome.open_url',
                                     return_value=mock_response)
