...
from ansible_collections.notmintest.not_a_real_collection.plugins.lookup.lastpass import LookupModule, LPass, LPassException
...
class TestLastpassPlugin(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.lastpass.LPass', new=MockLPass)
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.lastpass.LPass', LoggedOutMockLPass)
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.lastpass.LPass', DisconnectedMockLPass)
