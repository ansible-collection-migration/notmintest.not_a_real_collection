...
from ansible_collections.notmintest.not_a_real_collection.plugins.lookup.onepassword import OnePass, LookupModule
from ansible_collections.notmintest.not_a_real_collection.plugins.lookup.onepassword_raw import LookupModule as OnePasswordRawLookup
...
@patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.onepassword.OnePass', MockOnePass)
...
@patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.onepassword_raw.OnePass', MockOnePass)
