...
from ansible_collections.notmintest.not_a_real_collection.plugins.lookup.manifold import ManifoldApiClient, LookupModule, ApiError
import json
...
class TestManifoldApiClient(unittest.TestCase):
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.manifold.open_url')
...
class TestLookupModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.manifold.ManifoldApiClient')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.manifold.display')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.manifold.ManifoldApiClient')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.manifold.os.getenv')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.lookup.manifold.ManifoldApiClient')
