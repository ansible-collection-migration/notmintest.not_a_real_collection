...
from ansible_collections.notmintest.not_a_real_collection.plugins.action.synchronize import ActionModule
...
class TestSynchronizeAction(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.action.synchronize.connection_loader', FakePluginLoader)
    def test_basic(self):
        x = SynchronizeTester()
