...
from ansible_collections.notmintest.not_a_real_collection.tests.unit.compat.mock import mock_open, patch

from ansible.errors import AnsibleConnectionFailure
from ansible.module_utils.connection import ConnectionError
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.common import HTTPMethod, ResponseParams
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.fdm_swagger_client import SpecProp, FdmSwaggerParser
from ansible.module_utils.six import BytesIO, PY3, StringIO
from ansible_collections.notmintest.not_a_real_collection.plugins.httpapi.ftd import HttpApi, BASE_HEADERS, TOKEN_PATH_TEMPLATE, DEFAULT_API_VERSIONS
...
class TestFtdHttpApi(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.httpapi.ftd.encode_multipart_formdata',
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.httpapi.ftd.HttpApi._get_api_token_path', mock.MagicMock(return_value=None))
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.httpapi.ftd.HttpApi._get_known_token_paths')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.httpapi.ftd.HttpApi._get_known_token_paths')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.httpapi.ftd.HttpApi._send_login_request')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.httpapi.ftd.HttpApi._get_known_token_paths')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.httpapi.ftd.HttpApi._send_login_request')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.httpapi.ftd.HttpApi._set_api_token_path')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.httpapi.ftd.HttpApi._get_supported_api_versions')
