...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.hetzner import BASE_URL
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import hetzner_firewall
...
def run_module(mocker, module, arguments, fetch_url):
    ...
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.hetzner.fetch_url', fetch_url)
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.hetzner.time.sleep', lambda duration: None)
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.hetzner_firewall.AnsibleModule.exit_json', exit_json)
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.hetzner_firewall.AnsibleModule.fail_json', fail_json)
