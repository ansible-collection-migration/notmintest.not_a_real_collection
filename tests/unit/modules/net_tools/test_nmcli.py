...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nmcli
...
def mocker_set(mocker, connection_exists=False):
    ...
    """
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nmcli.HAVE_DBUS', True)
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nmcli.HAVE_NM_CLIENT', True)
