...
__metaclass__ = type
from ansible_collections.notmintest.not_a_real_collection.tests.unit.compat.mock import patch, call
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import parted as parted_module
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.parted import parse_partition_info
from ansible_collections.notmintest.not_a_real_collection.tests.unit.modules.utils import AnsibleExitJson, AnsibleFailJson, ModuleTestCase, set_module_args
...
class TestParted(ModuleTestCase):
    def setUp(self):
        ...
        self.mock_check_parted_label = (patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.parted.check_parted_label', return_value=False))
        self.check_parted_label = self.mock_check_parted_label.start()

        self.mock_parted = (patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.parted.parted'))
    ...
    def test_partition_already_exists(self):
        ...
        with patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.parted.get_device_info', return_value=parted_dict1):
    ...
    def test_create_label_gpt(self):
        ...
        with patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.parted.get_device_info', return_value=parted_dict2):
