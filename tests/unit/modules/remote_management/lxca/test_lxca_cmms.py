...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import lxca_cmms
...
class TestMyModule():
    ...
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.lxca_cmms.execute_module', autospec=True)
    ...
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.lxca_cmms.execute_module', autospec=True)
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.lxca_cmms.AnsibleModule', autospec=True)
    ...
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.remote_management.lxca.common.setup_conn', autospec=True)
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.lxca_cmms._cmms_by_uuid',
                autospec=True)
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.lxca_cmms.AnsibleModule',
                autospec=True)
