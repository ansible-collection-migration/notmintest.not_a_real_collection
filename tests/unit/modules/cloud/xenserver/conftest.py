...
def XenAPI():
    ...
    fake_xenapi = importlib.import_module('ansible_collections.notmintest.not_a_real_collection.tests.unit.modules.cloud.xenserver.FakeXenAPI')
...
def xenserver_guest_info(XenAPI):
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules import xenserver_guest_info
...
def xenserver_guest_powerstate(XenAPI):
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules import xenserver_guest_powerstate
