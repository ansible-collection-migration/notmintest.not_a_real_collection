...
import ansible_collections.notmintest.not_a_real_collection.tests.unit.compat.unittest as unittest
from ansible_collections.notmintest.not_a_real_collection.tests.unit.compat.mock import MagicMock
from ansible_collections.notmintest.not_a_real_collection.tests.unit.compat.unittest import TestCase
...
if sys.version_info[:2] != (2, 6):
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.cs_traffic_type import AnsibleCloudStackTrafficType, setup_module_object
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.cloudstack import HAS_LIB_CS
    if not HAS_LIB_CS:
