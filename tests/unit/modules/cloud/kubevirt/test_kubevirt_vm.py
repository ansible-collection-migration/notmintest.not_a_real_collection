...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.kubevirt import KubeVirtRawModule
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import kubevirt_vm as mymodule
