...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.s3_bucket_notification import AmazonBucket, Config
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import s3_bucket_notification
try:
...
class TestModule(ModuleTestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.s3_bucket_notification.AnsibleAWSModule.client')
