...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.aws_netapp_cvs_pool \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.aws_netapp_cvs_pool.NetAppAWSCVS.get_aws_netapp_cvs_pool')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.AwsCvsRestAPI.put')
