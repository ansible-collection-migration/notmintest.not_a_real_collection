...
from ansible_collections.notmintest.not_a_real_collection.tests.unit.compat.mock import MagicMock, Mock, patch
...
_temp = __import__('ansible_collections.notmintest.not_a_real_collection.plugins.modules.lambda')
