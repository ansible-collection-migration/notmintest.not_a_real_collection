...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.aws_netapp_cvs_snapshots \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.aws_netapp_cvs_snapshots.AwsCvsNetappSnapshot.getSnapshotId')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.aws_netapp_cvs_snapshots.AwsCvsNetappSnapshot.getfilesystemId')
