...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.aws_netapp_cvs_FileSystems \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystemId')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.AwsCvsRestAPI.get_state')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.AwsCvsRestAPI.post')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystemId')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.aws_netapp_cvs_FileSystems.AwsCvsNetappFileSystem.get_filesystem')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.AwsCvsRestAPI.get_state')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.AwsCvsRestAPI.delete')
