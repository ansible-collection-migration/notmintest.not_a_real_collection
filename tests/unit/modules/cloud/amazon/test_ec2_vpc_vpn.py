...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ec2_vpc_vpn
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.ec2 import get_aws_connection_info, boto3_conn, boto3_tag_list_to_ansible_dict
