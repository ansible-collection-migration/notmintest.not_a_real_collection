...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import enos_config
...
class TestEnosConfigModule(TestEnosModule):
    ...
    def setUp(self):
        self.patcher_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.enos_config.get_config')
        self.mock_get_config = self.patcher_get_config.start()
        self.patcher_exec_command = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.enos_config.load_config')
