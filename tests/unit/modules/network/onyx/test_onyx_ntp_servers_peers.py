...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import onyx_ntp_servers_peers
...
class TestOnyxNtpServersPeersModule(TestOnyxModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.onyx.onyx.load_config')
