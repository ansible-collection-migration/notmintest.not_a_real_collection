...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ce_is_is_interface
...
class TestCloudEngineLacpModule(TestCloudEngineModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ce_is_is_interface.get_nc_config')
        self.get_nc_config = self.mock_get_config.start()

        self.mock_set_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ce_is_is_interface.set_nc_config')
