...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ce_multicast_igmp_enable
from ansible_collections.notmintest.not_a_real_collection.tests.unit.modules.network.cloudengine.ce_module import TestCloudEngineModule, load_fixture
...
class TestCloudEngineLacpModule(TestCloudEngineModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ce_multicast_igmp_enable.get_nc_config')
        self.get_nc_config = self.mock_get_config.start()

        self.mock_set_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ce_multicast_igmp_enable.set_nc_config')
