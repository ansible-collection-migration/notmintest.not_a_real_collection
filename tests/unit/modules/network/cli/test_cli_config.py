...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cli_config
...
class TestCliConfigModule(TestCliModule):
    ...
    def setUp(self):
        ...
        self.mock_connection = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.cli_config.Connection')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.cli_config.run')
