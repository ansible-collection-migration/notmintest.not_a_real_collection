...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ironware_command
...
class TestIronwareCommandModule(TestIronwareModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ironware_command.run_commands')
