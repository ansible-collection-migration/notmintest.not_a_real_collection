...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import checkpoint_access_rule
...
class TestCheckpointAccessRule(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.checkpoint_access_rule.Connection')
        return connection_class_mock.return_value

    @pytest.fixture
    def get_access_rule_200(self, mocker):
        mock_function = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.checkpoint_access_rule.get_access_rule')
