...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cp_mgmt_group
...
function_path = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cp_mgmt_group.api_call'
