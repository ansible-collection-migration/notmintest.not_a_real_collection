...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import checkpoint_host
...
class TestCheckpointHost(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.checkpoint_host.Connection')
        return connection_class_mock.return_value

    @pytest.fixture
    def get_host_200(self, mocker):
        mock_function = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.checkpoint_host.get_host')
