...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cp_mgmt_dynamic_object
...
function_path = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cp_mgmt_dynamic_object.api_call'
