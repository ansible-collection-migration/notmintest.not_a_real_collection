...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import dellos9_facts
...
class TestDellos9Facts(TestDellos9Module):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.dellos9_facts.run_commands')
