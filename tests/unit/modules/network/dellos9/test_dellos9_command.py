...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import dellos9_command
...
class TestDellos9CommandModule(TestDellos9Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.dellos9_command.run_commands')
