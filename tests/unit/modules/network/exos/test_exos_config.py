...
from ansible_collections.notmintest.not_a_real_collection.plugins.cliconf.exos import Cliconf
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import exos_config
...
class TestExosConfigModule(TestExosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.exos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.exos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.exos_config.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_get_startup_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.exos_config.get_startup_config')
        self.get_startup_config = self.mock_get_startup_config.start()

        self.cliconf_obj = Cliconf(MagicMock())

        self.mock_get_diff = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.exos_config.get_diff')
    ...
    def test_exos_diff_startup_unchanged(self):
        mock_get_startup_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.exos_config.get_startup_config')
