...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import pn_cpu_class
...
class TestCpuClassModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.pn_cpu_class.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.pn_cpu_class.check_cli')
