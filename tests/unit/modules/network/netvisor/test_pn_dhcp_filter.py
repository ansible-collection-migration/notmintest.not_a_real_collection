...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import pn_dhcp_filter
...
class TestDhcpFilterModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.pn_dhcp_filter.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.pn_dhcp_filter.check_cli')
