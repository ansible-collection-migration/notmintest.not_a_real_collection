...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import pn_ipv6security_raguard_vlan
...
class TestIPV6SecurityReguardVlanModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.pn_ipv6security_raguard_vlan.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.pn_ipv6security_raguard_vlan.check_cli')
