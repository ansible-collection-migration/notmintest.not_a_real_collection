...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import pn_access_list_ip
...
class TestAccessListIpModule(TestNvosModule):
    ...
    def setUp(self):
        self.mock_run_nvos_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.pn_access_list_ip.run_cli')
        self.run_nvos_commands = self.mock_run_nvos_commands.start()

        self.mock_run_check_cli = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.pn_access_list_ip.check_cli')
