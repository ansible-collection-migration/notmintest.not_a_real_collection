...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import junos_netconf
...
class TestJunosCommandModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_capabilities = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.junos.get_capabilities')
