...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import junos_config
...
class TestJunosConfigModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_config.get_configuration')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_load_configuration = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_config.load_configuration')
        self.load_configuration = self.mock_load_configuration.start()

        self.mock_lock_configuration = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.junos.lock_configuration')
        self.lock_configuration = self.mock_lock_configuration.start()

        self.mock_unlock_configuration = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.junos.unlock_configuration')
        self.unlock_configuration = self.mock_unlock_configuration.start()

        self.mock_commit_configuration = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_config.commit_configuration')
        self.commit_configuration = self.mock_commit_configuration.start()

        self.mock_get_diff = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_config.get_diff')
        ...
        self.mock_netconf = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.junos.NetconfConnection')
        self.netconf_conn = self.mock_netconf.start()

        self.mock_exec_rpc = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_config.exec_rpc')
        self.exec_rpc = self.mock_exec_rpc.start()

        self.mock_netconf_rpc = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.common.netconf.NetconfConnection')
