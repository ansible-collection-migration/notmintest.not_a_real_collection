...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import junos_facts
...
class TestJunosCommandModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.facts.legacy.base.get_configuration')
        ...
        self.mock_exec_rpc = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.facts.legacy.base.exec_rpc')
        ...
        self.mock_get_resource_connection = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.common.facts.facts.get_resource_connection')
        self.get_resource_connection = self.mock_get_resource_connection.start()

        self.mock_get_capabilities = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.facts.legacy.base.get_capabilities')
