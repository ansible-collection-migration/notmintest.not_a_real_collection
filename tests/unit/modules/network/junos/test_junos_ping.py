...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import junos_ping
...
class TestJunosPingModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_connection = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_ping.get_connection')
