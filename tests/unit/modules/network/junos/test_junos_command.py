...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import junos_command
...
class TestJunosCommandModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_conn = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.junos.Connection')
        ...
        self.mock_exec_rpc = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_command.exec_rpc')
        ...
        self.mock_get_connection = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_command.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.mock_get_capabilities = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_command.get_capabilities')
