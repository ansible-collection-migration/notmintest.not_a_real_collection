...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import junos_rpc
...
class TestJunosCommandModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_rpc = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_rpc.exec_rpc')
