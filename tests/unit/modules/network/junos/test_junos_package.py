...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import junos_package
...
class TestJunosPackageModule(TestJunosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_device = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.junos_package.get_device')
