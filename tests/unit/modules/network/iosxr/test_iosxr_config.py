...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import iosxr_config
...
class TestIosxrConfigModule(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.patcher_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.iosxr_config.get_config')
        self.mock_get_config = self.patcher_get_config.start()

        self.patcher_exec_command = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.iosxr_config.load_config')
        self.mock_exec_command = self.patcher_exec_command.start()

        self.mock_get_connection = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.iosxr_config.get_connection')
