...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import iosxr_user
...
class TestIosxrUserModule(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.iosxr_user.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.iosxr_user.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_is_cliconf = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.iosxr_user.is_cliconf')
