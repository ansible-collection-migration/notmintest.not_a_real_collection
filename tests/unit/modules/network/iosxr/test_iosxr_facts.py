...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import iosxr_facts
...
class TestIosxrFacts(TestIosxrModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.iosxr.facts.legacy.base.run_commands')
        ...
        self.mock_get_capabilities = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.iosxr.facts.legacy.base.get_capabilities')
