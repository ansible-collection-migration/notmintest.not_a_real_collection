...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import opx_cps
...
class TestOpxCpsModule(TestOpxModule):
    ...
    def setUp(self):
        ...
        self.mock_cps_get = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.opx_cps.cps_get')
        self.cps_get = self.mock_cps_get.start()

        self.mock_cps_transaction = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.opx_cps.cps_transaction')
        self.cps_transaction = self.mock_cps_transaction.start()

        self.mock_parse_cps_parameters = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.opx_cps.parse_cps_parameters')
        self.parse_cps_parameters = self.mock_parse_cps_parameters.start()

        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.opx_cps.cps_get.parse_cps_parameters')
