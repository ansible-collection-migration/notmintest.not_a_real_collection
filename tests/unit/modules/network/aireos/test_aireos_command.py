...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import aireos_command
...
class TestCiscoWlcCommandModule(TestCiscoWlcModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.aireos_command.run_commands')
