...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import edgeswitch_facts
...
class TestEdgeswitchFactsModule(TestEdgeswitchModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.edgeswitch_facts.run_commands')
