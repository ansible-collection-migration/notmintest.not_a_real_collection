...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import icx_vlan
...
class TestICXVlanModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.icx_vlan.exec_command')
        self.exec_command = self.mock_exec_command.start()

        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.icx_vlan.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.icx_vlan.get_config')
