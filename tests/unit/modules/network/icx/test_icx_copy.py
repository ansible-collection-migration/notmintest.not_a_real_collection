...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import icx_copy
...
class TestICXSCPModule(TestICXModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_scp = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.icx_copy.exec_scp')
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.icx_copy.run_commands')
        self.exec_command = self.mock_exec_scp.start()
        self.run_commands = self.mock_run_commands.start()
        self.mock_exec_command = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.icx_copy.exec_command')
