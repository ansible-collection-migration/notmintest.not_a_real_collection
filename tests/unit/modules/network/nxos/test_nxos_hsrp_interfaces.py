...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nxos_hsrp_interfaces
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.config.hsrp_interfaces.hsrp_interfaces import Hsrp_interfaces
...
class TestNxosHsrpInterfacesModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_edit_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.config.hsrp_interfaces.hsrp_interfaces.Hsrp_interfaces.edit_config')
