...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nxos_interfaces
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.config.interfaces.interfaces import Interfaces
...
class TestNxosInterfacesModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_edit_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.config.interfaces.interfaces.Interfaces.edit_config')
        self.edit_config = self.mock_edit_config.start()
        self.mock__device_info = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.facts.interfaces.interfaces.InterfacesFacts._device_info')
