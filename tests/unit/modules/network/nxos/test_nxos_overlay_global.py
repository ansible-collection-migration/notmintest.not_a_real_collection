...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nxos_overlay_global
...
class TestNxosOverlayGlobalModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nxos_overlay_global.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nxos_overlay_global.get_config')
