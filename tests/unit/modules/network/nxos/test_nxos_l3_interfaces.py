...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nxos_l3_interfaces
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.config.l3_interfaces.l3_interfaces import L3_interfaces
...
class TestNxosL3InterfacesModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_edit_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.config.l3_interfaces.l3_interfaces.L3_interfaces.edit_config')
        self.edit_config = self.mock_edit_config.start()

        self.mock_get_platform_type = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.config.l3_interfaces.l3_interfaces.L3_interfaces.get_platform_type')
