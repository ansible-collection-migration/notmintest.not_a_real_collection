...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nxos_vlans
...
class TestNxosVlansModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_edit_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.config.vlans.vlans.Vlans.edit_config')
        self.edit_config = self.mock_edit_config.start()

        self.mock_get_device_data = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.facts.vlans.vlans.VlansFacts.get_device_data')
