...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nxos_vrf
...
class TestNxosVrfModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nxos_vrf.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nxos_vrf.run_commands')
