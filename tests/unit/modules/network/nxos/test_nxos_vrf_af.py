...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nxos_vrf_af
...
class TestNxosVrfafModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nxos_vrf_af.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nxos_vrf_af.get_config')
