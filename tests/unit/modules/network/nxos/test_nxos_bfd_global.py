...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nxos_bfd_global
...
class TestNxosBfdGlobalModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nxos_bfd_global.load_config')
