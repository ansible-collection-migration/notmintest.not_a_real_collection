...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nxos_evpn_vni
...
class TestNxosEvpnVniModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nxos_evpn_vni.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.nxos_evpn_vni.get_config')
