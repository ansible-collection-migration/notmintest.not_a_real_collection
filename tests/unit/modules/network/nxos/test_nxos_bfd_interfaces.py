...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import nxos_bfd_interfaces
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.config.bfd_interfaces.bfd_interfaces import Bfd_interfaces
...
class TestNxosBfdInterfacesModule(TestNxosModule):
    ...
    def setUp(self):
        ...
        self.mock_edit_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.config.bfd_interfaces.bfd_interfaces.Bfd_interfaces.edit_config')
