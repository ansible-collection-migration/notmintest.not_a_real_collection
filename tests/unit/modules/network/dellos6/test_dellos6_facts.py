...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import dellos6_facts
...
class TestDellos6Facts(TestDellos6Module):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.dellos6_facts.run_commands')
