...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import dellos6_command
...
class TestDellos6CommandModule(TestDellos6Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.dellos6_command.run_commands')
