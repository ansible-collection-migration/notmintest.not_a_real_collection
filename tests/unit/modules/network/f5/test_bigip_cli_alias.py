...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_cli_alias import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_cli_alias import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_cli_alias import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_cli_alias import ArgumentSpec
