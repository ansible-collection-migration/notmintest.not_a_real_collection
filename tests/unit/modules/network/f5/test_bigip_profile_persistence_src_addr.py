...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_persistence_src_addr import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_persistence_src_addr import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_persistence_src_addr import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_persistence_src_addr import ArgumentSpec
