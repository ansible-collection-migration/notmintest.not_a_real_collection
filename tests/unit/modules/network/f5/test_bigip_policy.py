...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_policy import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_policy import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_policy import SimpleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_policy import ArgumentSpec
