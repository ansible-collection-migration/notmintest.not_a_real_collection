...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ucs_fetch import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ucs_fetch import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ucs_fetch import V1Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ucs_fetch import ArgumentSpec
