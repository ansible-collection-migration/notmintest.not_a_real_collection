...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_regkey_pool import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_regkey_pool import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_regkey_pool import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_regkey_pool import ArgumentSpec
