...
try:
    ...
    try:
        from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_pool import Parameters
        from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_pool import ModuleManager
        from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_pool import PoolFactManager
        from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_pool import TypedPoolFactManager
