...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_lx_package import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_lx_package import ArgumentSpec
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_lx_package import ModuleManager
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_lx_package.tmos_version')
            self.m1 = self.p1.start()
            self.m1.return_value = '12.1.3'
