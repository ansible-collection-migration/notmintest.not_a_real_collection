...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snat_translation import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snat_translation import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snat_translation import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snat_translation import ArgumentSpec
