...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_traffic_selector import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_traffic_selector import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_traffic_selector import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_traffic_selector import ArgumentSpec
