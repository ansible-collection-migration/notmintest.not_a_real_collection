...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_wait import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_wait import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_wait import ArgumentSpec
