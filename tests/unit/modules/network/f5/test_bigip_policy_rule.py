...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_policy_rule import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_policy_rule import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_policy_rule import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_policy_rule import ArgumentSpec
