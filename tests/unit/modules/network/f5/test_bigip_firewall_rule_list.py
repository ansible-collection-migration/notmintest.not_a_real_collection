...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_rule_list import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_rule_list import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_rule_list import ArgumentSpec
