...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_signature_set import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_signature_set import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_signature_set import ArgumentSpec
...
class TestParameters(unittest.TestCase):
    def test_module_parameters(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_signature_set.tmos_version')
            self.m1 = self.p1.start()
            self.m1.return_value = '13.1.0'
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_signature_set.module_provisioned')
            self.p2 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_signature_set.tmos_version')
            self.m1 = self.p1.start()
            self.m2 = self.p2.start()
            self.m2.return_value = '13.1.0'
            self.m1.return_value = True
