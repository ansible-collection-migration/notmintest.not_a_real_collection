...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_dos_vector import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_dos_vector import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_dos_vector import ArgumentSpec
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_dos_vector import ProtocolDnsManager
