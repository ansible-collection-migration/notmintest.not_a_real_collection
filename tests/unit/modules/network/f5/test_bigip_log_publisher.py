...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_log_publisher import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_log_publisher import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_log_publisher import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_log_publisher import ArgumentSpec
