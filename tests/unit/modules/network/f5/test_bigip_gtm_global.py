...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_global import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_global import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_global import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_global import ArgumentSpec
