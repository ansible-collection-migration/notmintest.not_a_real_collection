...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_software_install import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_software_install import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_software_install import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_software_install import ArgumentSpec
