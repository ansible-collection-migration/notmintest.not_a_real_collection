...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_waf import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_waf import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_waf import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_waf.bigiq_version')
            self.p2 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_waf.ModuleParameters.template_reference')
            self.p3 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_waf.ModuleParameters.ssg_reference')
            self.p4 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_waf.ModuleParameters.default_device_reference')
