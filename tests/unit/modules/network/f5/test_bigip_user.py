...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_user import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_user import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_user import ArgumentSpec
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_user import UnpartitionedManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_user import PartitionedManager
