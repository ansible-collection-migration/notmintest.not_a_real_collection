...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_peer import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_peer import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_peer import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_peer import GenericModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_peer import ArgumentSpec
