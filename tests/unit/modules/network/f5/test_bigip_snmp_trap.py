...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_trap import V2Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_trap import V1Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_trap import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_trap import V2Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_trap import V1Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_trap import ArgumentSpec
    ...
    from ansible_collections.notmintest.not_a_real_collection.tests.unit.compat.mock import DEFAULT
