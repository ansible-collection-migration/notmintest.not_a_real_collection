...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_software_image import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_software_image import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_software_image import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_software_image import ArgumentSpec
