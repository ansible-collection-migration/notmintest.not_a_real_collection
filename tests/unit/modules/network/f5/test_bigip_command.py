...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_command import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_command import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_command import V1Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_command import V2Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_command import ArgumentSpec
