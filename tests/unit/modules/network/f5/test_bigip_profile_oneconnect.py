...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_oneconnect import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_oneconnect import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_oneconnect import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_oneconnect import ArgumentSpec
