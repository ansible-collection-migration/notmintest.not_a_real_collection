...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snat_pool import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snat_pool import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snat_pool import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snat_pool import ArgumentSpec
