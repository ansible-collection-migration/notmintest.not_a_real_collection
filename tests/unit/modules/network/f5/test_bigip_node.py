...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_node import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_node import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_node import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_node import ArgumentSpec
