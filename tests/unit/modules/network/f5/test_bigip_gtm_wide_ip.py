...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_wide_ip import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_wide_ip import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_wide_ip import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_wide_ip import ArgumentSpec
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_wide_ip import UntypedManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_wide_ip import TypedManager
...
class TestUntypedManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_wide_ip.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
