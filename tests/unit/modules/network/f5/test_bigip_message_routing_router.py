...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_router import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_router import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_router import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_router import GenericModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_router import ArgumentSpec
