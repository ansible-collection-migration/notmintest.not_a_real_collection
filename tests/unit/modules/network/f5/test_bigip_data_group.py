...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_data_group import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_data_group import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_data_group import ExternalManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_data_group import InternalManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_data_group import ArgumentSpec
