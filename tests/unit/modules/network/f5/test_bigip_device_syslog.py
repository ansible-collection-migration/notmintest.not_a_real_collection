...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_device_syslog import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_device_syslog import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_device_syslog import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_device_syslog import ArgumentSpec
