...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_dns_resolver import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_dns_resolver import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_dns_resolver import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_dns_resolver import ArgumentSpec
