...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_protocol import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_protocol import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_protocol import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_protocol import ArgumentSpec
