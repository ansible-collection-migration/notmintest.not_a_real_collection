...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_server import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_server import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_server import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_server import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_server.modules_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = ['ltm', 'gtm', 'asm']
            self.p2 = patch(
                'ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_server.Parameters._read_current_clientssl_profiles_from_device'
            )
            self.p3 = patch(
                'ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_server.Parameters._read_current_serverssl_profiles_from_device'
            )
            self.p4 = patch(
                'ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_server.VirtualServerValidator.check_create'
            )
            self.p5 = patch(
                'ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_server.VirtualServerValidator.check_update'
            )
            self.m2 = self.p2.start()
            self.m3 = self.p3.start()
            self.m4 = self.p4.start()
