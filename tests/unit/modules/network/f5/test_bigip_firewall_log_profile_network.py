...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_log_profile_network import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_log_profile_network import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_log_profile_network import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_log_profile_network import ArgumentSpec
