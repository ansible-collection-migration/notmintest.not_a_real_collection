...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_vcmp_guest import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_vcmp_guest import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_vcmp_guest import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_vcmp_guest import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_vcmp_guest.ModuleParameters.initial_image_exists')
            self.m1 = self.p1.start()
            self.m1.return_value = True
            self.p2 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_vcmp_guest.ModuleParameters.initial_hotfix_exists')
            self.m2 = self.p2.start()
            self.m2.return_value = True
