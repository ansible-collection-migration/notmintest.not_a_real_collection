...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_remote_role import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_remote_role import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_remote_role import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_remote_role import ArgumentSpec
