...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_persistence_cookie import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_persistence_cookie import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_persistence_cookie import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_persistence_cookie import ArgumentSpec
