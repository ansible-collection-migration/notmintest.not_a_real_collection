...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_iapp_template import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_iapp_template import ArgumentSpec
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_iapp_template import ModuleManager
