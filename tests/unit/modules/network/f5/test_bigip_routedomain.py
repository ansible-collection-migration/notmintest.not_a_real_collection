...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_routedomain import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_routedomain import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_routedomain import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_routedomain import ArgumentSpec
