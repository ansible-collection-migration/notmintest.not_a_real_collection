...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_https import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_https import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_https import ArgumentSpec
