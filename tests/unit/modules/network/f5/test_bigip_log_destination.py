...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_log_destination import V1ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_log_destination import V1ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_log_destination import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_log_destination import V1Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_log_destination import ArgumentSpec
