...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_offload import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_offload import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_offload import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_offload.bigiq_version')
            self.p2 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_offload.ModuleParameters.template_reference')
            self.p3 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_offload.ModuleParameters.ssg_reference')
            self.p4 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_https_offload.ModuleParameters.default_device_reference')
