...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_irule import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_irule import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_irule import ArgumentSpec
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_irule import GtmManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_irule import LtmManager
