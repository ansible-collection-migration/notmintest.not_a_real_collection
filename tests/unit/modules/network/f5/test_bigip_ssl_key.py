...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ssl_key import ArgumentSpec
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ssl_key import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ssl_key import ModuleManager
