...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_address import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_address import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_address import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_virtual_address import ArgumentSpec
