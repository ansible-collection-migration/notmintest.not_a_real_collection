...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_transport_config import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_transport_config import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_transport_config import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_transport_config import GenericModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_message_routing_transport_config import ArgumentSpec
