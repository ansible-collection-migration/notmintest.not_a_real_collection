...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_tcp import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_tcp import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_tcp import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_tcp.bigiq_version')
            self.p2 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_tcp.ModuleParameters.template_reference')
            self.p3 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_tcp.ModuleParameters.default_device_reference')
