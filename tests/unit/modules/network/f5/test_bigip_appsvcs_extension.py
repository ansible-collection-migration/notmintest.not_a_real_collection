...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_appsvcs_extension import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_appsvcs_extension import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_appsvcs_extension import ArgumentSpec
