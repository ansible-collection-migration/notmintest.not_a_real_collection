...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_tcp import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_tcp import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_tcp import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_tcp import ArgumentSpec
