...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_static_route import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_static_route import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_static_route import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_static_route import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def test_invalid_unknown_params(self, *args):
        ...
        with patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.f5_utils.AnsibleModule.fail_json') as mo:
