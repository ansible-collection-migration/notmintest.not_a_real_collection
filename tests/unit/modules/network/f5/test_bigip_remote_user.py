...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_remote_user import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_remote_user import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_remote_user import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_remote_user import ArgumentSpec
