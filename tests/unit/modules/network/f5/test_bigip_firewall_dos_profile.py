...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_dos_profile import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_dos_profile import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_dos_profile import ArgumentSpec
