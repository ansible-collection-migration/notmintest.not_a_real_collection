...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_gateway_icmp import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_gateway_icmp import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_gateway_icmp import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_gateway_icmp import ArgumentSpec
