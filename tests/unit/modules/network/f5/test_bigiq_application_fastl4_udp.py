...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_udp import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_udp import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_udp import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_udp.bigiq_version')
            self.p2 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_udp.ModuleParameters.template_reference')
            self.p3 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_application_fastl4_udp.ModuleParameters.default_device_reference')
