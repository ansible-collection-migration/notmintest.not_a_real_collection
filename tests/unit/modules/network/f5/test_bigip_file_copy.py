...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_file_copy import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_file_copy import IFileManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_file_copy import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_file_copy import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_file_copy import ArgumentSpec
