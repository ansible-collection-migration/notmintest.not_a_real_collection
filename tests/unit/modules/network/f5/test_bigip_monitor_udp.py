...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_udp import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_udp import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_udp import ArgumentSpec
