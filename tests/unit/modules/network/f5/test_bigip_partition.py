...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_partition import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_partition import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_partition import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_partition import ArgumentSpec
