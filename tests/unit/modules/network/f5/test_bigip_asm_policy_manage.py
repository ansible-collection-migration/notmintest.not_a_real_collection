...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_manage import V1Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_manage import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_manage import V1Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_manage import ArgumentSpec
...
class TestManager(unittest.TestCase):
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_asm_policy_manage.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
