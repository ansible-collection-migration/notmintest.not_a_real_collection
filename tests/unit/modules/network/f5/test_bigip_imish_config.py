...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_imish_config import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_imish_config import ArgumentSpec
