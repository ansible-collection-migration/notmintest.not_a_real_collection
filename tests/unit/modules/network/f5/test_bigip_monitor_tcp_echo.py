...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_tcp_echo import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_tcp_echo import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_tcp_echo import ArgumentSpec
