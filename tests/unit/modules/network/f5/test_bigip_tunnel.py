...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_tunnel import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_tunnel import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_tunnel import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_tunnel import ArgumentSpec
