...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ssl_certificate import ArgumentSpec
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ssl_certificate import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ssl_certificate import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_ssl_certificate import ModuleManager
