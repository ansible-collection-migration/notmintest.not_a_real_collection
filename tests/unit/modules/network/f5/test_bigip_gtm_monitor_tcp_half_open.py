...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_monitor_tcp_half_open import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_monitor_tcp_half_open import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_monitor_tcp_half_open import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_monitor_tcp_half_open import ArgumentSpec
...
class TestManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_monitor_tcp_half_open.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
