...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_tcp_half_open import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_tcp_half_open import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_monitor_tcp_half_open import ArgumentSpec
