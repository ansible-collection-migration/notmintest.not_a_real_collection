...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_address_list import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_address_list import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_address_list import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_firewall_address_list import ArgumentSpec
