...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_cli_script import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_cli_script import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_cli_script import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_cli_script import ArgumentSpec
