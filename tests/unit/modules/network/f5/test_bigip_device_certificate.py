...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_device_certificate import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_device_certificate import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_device_certificate import ArgumentSpec
