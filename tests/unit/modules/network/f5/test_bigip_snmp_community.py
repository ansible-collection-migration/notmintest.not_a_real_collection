...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_community import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_community import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_community import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_community import V1Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_community import V2Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_snmp_community import ArgumentSpec
