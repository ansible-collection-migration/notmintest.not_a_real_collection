...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_server import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_server import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_server import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_server import V1Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_server import V2Manager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_server import ArgumentSpec
...
class TestV1Manager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            self.p1 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_server.module_provisioned')
            self.m1 = self.p1.start()
            self.m1.return_value = True
        ...
        try:
            ...
            self.p2 = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_gtm_server.tmos_version')
            self.m2 = self.p2.start()
            self.m2.return_value = '13.0.0'
