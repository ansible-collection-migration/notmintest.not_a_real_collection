...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_hostname import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_hostname import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_hostname import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_hostname import ArgumentSpec
