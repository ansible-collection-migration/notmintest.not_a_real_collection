...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_analytics import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_analytics import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_analytics import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_profile_analytics import ArgumentSpec
