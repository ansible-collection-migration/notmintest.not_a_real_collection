...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_configsync_action import Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_configsync_action import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_configsync_action import ArgumentSpec
