...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_device_discovery import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_device_discovery import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_device_discovery import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigiq_device_discovery import ArgumentSpec
