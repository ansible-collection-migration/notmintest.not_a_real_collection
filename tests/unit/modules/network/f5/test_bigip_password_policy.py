...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_password_policy import ApiParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_password_policy import ModuleParameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_password_policy import ModuleManager
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules.bigip_password_policy import ArgumentSpec
...
@patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.f5_utils.AnsibleF5Client._get_mgmt_root',
       return_value=True)
