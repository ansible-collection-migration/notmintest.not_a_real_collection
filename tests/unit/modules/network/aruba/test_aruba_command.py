...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import aruba_command
...
class TestArubaCommandModule(TestArubaModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.aruba_command.run_commands')
