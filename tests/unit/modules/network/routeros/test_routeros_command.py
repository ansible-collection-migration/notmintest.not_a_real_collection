...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import routeros_command
...
class TestRouterosCommandModule(TestRouterosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.routeros_command.run_commands')
