...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ftd_file_upload
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.fdm_swagger_client import OperationField
...
class TestFtdFileUpload(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ftd_file_upload.Connection')
