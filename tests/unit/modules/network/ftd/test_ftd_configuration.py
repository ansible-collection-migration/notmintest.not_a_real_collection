...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.common import FtdConfigurationError, FtdServerError, FtdUnexpectedResponse
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.configuration import FtdInvalidOperationNameError, CheckModeException
...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ftd_configuration
...
class TestFtdConfiguration(object):
    ...
    def resource_mock(self, mocker):
        resource_class_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ftd_configuration.BaseConfigurationResource')
