...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.common import HTTPMethod
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.fdm_swagger_client import FILE_MODEL_NAME, OperationField
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ftd_file_download
...
class TestFtdFileDownload(object):
    ...
    def connection_mock(self, mocker):
        connection_class_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ftd_file_download.Connection')
