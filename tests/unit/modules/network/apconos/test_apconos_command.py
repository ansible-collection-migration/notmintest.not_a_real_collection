...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import apconos_command
...
class TestApconosCommandModule(TestApconosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.apconos_command.run_commands')
