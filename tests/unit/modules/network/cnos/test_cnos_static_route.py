...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cnos_static_route
...
class TestCnosStaticRouteModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_exec_command = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_banner.exec_command')
        self.exec_command = self.mock_exec_command.start()

        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_static_route.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_static_route.get_config')
