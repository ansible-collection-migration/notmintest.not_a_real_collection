...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cnos_config
...
class TestCnosConfigModule(TestCnosModule):
    ...
    def setUp(self):
        self.patcher_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_config.get_config')
        self.mock_get_config = self.patcher_get_config.start()
        self.patcher_exec_command = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_config.load_config')
