...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cnos_vlan
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_vlan import parse_vlan_brief
...
class TestCnosVlanModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_vlan.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_vlan.load_config')
