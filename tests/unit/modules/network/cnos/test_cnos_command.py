...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cnos_command
...
class TestCnosCommandModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_command.run_commands')
