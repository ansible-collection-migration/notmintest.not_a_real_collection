...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cnos_l2_interface
...
class TestCnosL2InterfaceModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_l2_interface.get_config'
        )
        self._patch_load_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_l2_interface.load_config'
        )
        self._patch_run_commands = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_l2_interface.run_commands'
        )
