...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cnos_linkagg
...
class TestCnosLinkaggModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_linkagg.get_config'
        )
        self._patch_load_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_linkagg.load_config'
        )
