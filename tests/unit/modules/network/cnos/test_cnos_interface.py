...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cnos_interface
...
class TestCnosInterfaceModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_interface.get_config'
        )
        self._patch_load_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_interface.load_config'
        )
        self._patch_exec_command = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_interface.exec_command'
        )
