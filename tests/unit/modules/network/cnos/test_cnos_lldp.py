...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cnos_lldp
...
class TestCnosLldpModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_lldp.get_config'
        )
        self._patch_load_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_lldp.load_config'
        )
        self._patch_get_ethernet_range = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.cnos_lldp.get_ethernet_range'
        )
