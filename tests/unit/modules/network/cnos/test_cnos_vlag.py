...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import cnos_vlag
...
class TestCnosVlagModule(TestCnosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_cnos_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.cnos.cnos.run_cnos_commands')
