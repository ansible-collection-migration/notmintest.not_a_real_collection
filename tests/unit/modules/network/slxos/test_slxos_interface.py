...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import slxos_interface
...
class TestSlxosInterfaceModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.slxos_interface.get_config'
        )
        self._patch_load_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.slxos_interface.load_config'
        )
        self._patch_exec_command = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.slxos_interface.exec_command'
        )
