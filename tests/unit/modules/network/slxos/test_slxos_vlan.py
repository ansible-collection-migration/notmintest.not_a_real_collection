...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import slxos_vlan
...
class TestSlxosVlanModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self._patch_run_commands = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.slxos_vlan.run_commands'
        )
        self._patch_load_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.slxos_vlan.load_config'
        )
