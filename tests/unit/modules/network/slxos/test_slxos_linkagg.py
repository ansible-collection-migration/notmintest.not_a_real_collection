...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import slxos_linkagg
...
class TestSlxosLinkaggModule(TestSlxosModule):
    ...
    def setUp(self):
        ...
        self._patch_get_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.slxos_linkagg.get_config'
        )
        self._patch_load_config = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.slxos_linkagg.load_config'
        )
