...
try:
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules import fortios_system_firmware_upgrade
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.fortios_system_firmware_upgrade.Connection')
...
def test_system_firmware_upgrade_execute(mocker):
    ...
    execute_method_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.fortios.fortios.FortiOSHandler.execute', return_value=execute_method_result)
