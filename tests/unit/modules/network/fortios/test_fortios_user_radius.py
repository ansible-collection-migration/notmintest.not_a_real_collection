...
try:
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules import fortios_user_radius
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.fortios_user_radius.Connection')
