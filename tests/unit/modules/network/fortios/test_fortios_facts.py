...
from ansible_collections.notmintest.not_a_real_collection.tests.unit.modules.utils import exit_json, fail_json
...
try:
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.fortios.facts.facts import Facts
    from ansible_collections.notmintest.not_a_real_collection.plugins.modules import fortios_facts
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.fortios_facts.Connection')
...
def test_facts_get(mocker):
    ...
    monitor_method_mock = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.fortios.fortios.FortiOSHandler.monitor', return_value=monitor_method_result)
