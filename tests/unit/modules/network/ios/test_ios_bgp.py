...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ios.providers.cli.config.bgp.process import Provider
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ios_bgp
