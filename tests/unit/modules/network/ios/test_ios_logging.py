...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ios_logging
...
class TestIosLoggingModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ios_logging.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ios_logging.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_get_capabilities = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ios_logging.get_capabilities')
