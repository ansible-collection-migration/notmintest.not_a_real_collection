...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ios_config
from ansible_collections.notmintest.not_a_real_collection.plugins.cliconf.ios import Cliconf
...
class TestIosConfigModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ios_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_get_connection = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ios_config.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.conn = self.get_connection()
        self.conn.edit_config = MagicMock()

        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ios_config.run_commands')
