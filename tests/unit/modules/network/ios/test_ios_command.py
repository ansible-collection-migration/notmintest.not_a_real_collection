...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ios_command
...
class TestIosCommandModule(TestIosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ios_command.run_commands')
