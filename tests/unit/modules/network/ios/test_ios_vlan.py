...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import _ios_vlan
from ansible_collections.notmintest.not_a_real_collection.plugins.modules._ios_vlan import parse_vlan_brief
