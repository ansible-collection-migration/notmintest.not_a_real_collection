...
import mock
import unittest
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import iap_start_workflow


class TestWorkflowModule(unittest.TestCase):

    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.iap_start_workflow.start_workflow')
