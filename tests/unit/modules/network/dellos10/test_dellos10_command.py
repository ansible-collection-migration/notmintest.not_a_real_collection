...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import dellos10_command
...
class TestDellos10CommandModule(TestDellos10Module):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.dellos10_command.run_commands')
