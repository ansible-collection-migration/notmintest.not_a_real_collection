...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import dellos10_facts
...
class TestDellos10Facts(TestDellos10Module):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.dellos10_facts.run_commands')
