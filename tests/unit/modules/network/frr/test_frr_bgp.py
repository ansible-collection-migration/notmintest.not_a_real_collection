...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.frr.providers.cli.config.bgp.process import Provider
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import frr_bgp
