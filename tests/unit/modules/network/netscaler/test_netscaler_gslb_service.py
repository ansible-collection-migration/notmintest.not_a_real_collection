...
from ansible_collections.notmintest.not_a_real_collection.tests.unit.compat.mock import patch, Mock, MagicMock, call
...
class TestNetscalerGSLBSiteModule(TestModule):
    ...
    def test_graceful_nitro_api_import_error(self):
        ...
        self.nitro_base_patcher.stop()
        self.nitro_specific_patcher.stop()
        from ansible_collections.notmintest.not_a_real_collection.plugins.modules import netscaler_gslb_service
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.netscaler_gslb_service.get_nitro_client', m):
            with patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.netscaler_gslb_service.nitro_exception', MockException):
                self.module = netscaler_gslb_service
                result = self.failed()
    ...
    def test_graceful_no_connection_error(self):
        ...
        m = Mock(return_value=client_mock)
        with patch.multiple(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netscaler_gslb_service',
            get_nitro_client=m,
