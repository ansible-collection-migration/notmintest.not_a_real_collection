...
class TestNetscalerGSLBVserverModule(TestModule):
    ...
    def test_graceful_nitro_error_on_login(self):
        ...
        with patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.netscaler_gslb_vserver.get_nitro_client', m):
            with patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.netscaler_gslb_vserver.nitro_exception', MockException):
                self.module = netscaler_gslb_vserver
                result = self.failed()
