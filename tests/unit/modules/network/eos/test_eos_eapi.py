...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import eos_eapi
...
class TestEosEapiModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.eos_eapi.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.eos_eapi.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_verify_state = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.eos_eapi.verify_state')
