...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import eos_config
from ansible_collections.notmintest.not_a_real_collection.plugins.cliconf.eos import Cliconf
...
class TestEosConfigModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.eos_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_get_connection = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.eos_config.get_connection')
        self.get_connection = self.mock_get_connection.start()

        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.eos_config.load_config')
        self.load_config = self.mock_load_config.start()
        self.mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.eos_config.run_commands')
        self.run_commands = self.mock_run_commands.start()

        self.mock_supports_sessions = patch('ansible_collections.notmintest.not_a_real_collection.plugins.cliconf.eos.Cliconf.supports_sessions')
    ...
    def test_eos_config_save_when(self):
        mock_run_commands = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.eos_config.run_commands')
