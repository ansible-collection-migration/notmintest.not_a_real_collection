...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import eos_interfaces
...
class TestEosInterfacesModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.eos.facts.interfaces.interfaces.InterfacesFacts.get_device_data')
