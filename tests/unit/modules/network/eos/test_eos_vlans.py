...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import eos_vlans
...
class TestEosVlansModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.eos.config.vlans.vlans.Vlans.get_vlans_facts')
