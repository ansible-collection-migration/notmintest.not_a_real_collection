...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import eos_l2_interfaces
...
class TestEosL2InterfacesModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_execute_show_command = patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.eos.facts.l2_interfaces.l2_interfaces.L2_interfacesFacts.get_device_data')
