...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import eos_user
...
class TestEosUserModule(TestEosModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.eos_user.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.eos_user.load_config')
