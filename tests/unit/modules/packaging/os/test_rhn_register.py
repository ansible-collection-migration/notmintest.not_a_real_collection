...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import rhn_register
...
def test_systemid_with_requirements(capfd, mocker, patch_rhn):
    ...
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.rhn_register.open', mock_open(read_data=SYSTEMID), create=True)
