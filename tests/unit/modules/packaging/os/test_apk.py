...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import apk
...
class TestApkQueryLatest(unittest.TestCase):
    ...
    @mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.apk.AnsibleModule')
