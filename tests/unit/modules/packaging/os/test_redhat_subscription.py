...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import redhat_subscription
...
def patch_redhat_subscription(mocker):
    ...
    """
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.redhat_subscription.RegistrationBase.REDHAT_REPO')
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.redhat_subscription.isfile', return_value=False)
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.redhat_subscription.unlink', return_value=True)
    mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.redhat_subscription.AnsibleModule.get_bin_path',
