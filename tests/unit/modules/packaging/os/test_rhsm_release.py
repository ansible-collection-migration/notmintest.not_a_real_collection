...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import rhsm_release
from ansible_collections.notmintest.not_a_real_collection.tests.unit.modules.utils import (
...
class RhsmRepositoryReleaseModuleTestCase(ModuleTestCase):
    ...
    def setUp(self):
        ...
        self.mock_run_command = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.rhsm_release.'
        ...
        self.mock_get_bin_path = patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.rhsm_release.'
