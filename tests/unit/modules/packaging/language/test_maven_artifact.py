...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import maven_artifact
...
def test_find_version_by_spec(mocker, version_by_spec, version_choosed):
    _getContent = mocker.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.maven_artifact.MavenDownloader._getContent')
