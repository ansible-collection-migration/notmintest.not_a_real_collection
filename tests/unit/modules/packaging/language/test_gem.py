...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import gem
...
class TestGem(ModuleTestCase):
    def setUp(self):
        ...
        self.mocker.patch(
            'ansible_collections.notmintest.not_a_real_collection.plugins.modules.gem.get_rubygems_path',
    ...
    def patch_installed_versions(self, versions):
        ...
        target = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.gem.get_installed_versions'
    ...
    def patch_rubygems_version(self, version=None):
        target = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.gem.get_rubygems_version'
