...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules import ss_3par_cpg
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.storage.hpe3par import hpe3par


@mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ss_3par_cpg.client')
@mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ss_3par_cpg.AnsibleModule')
@mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ss_3par_cpg.create_cpg')
...
@mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ss_3par_cpg.client')
@mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ss_3par_cpg.AnsibleModule')
@mock.patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.ss_3par_cpg.delete_cpg')
