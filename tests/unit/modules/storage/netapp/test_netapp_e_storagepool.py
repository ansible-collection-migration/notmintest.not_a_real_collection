...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_storagepool import NetAppESeriesStoragePool
...
class StoragePoolTest(ModuleTestCase):
    ...
    REQUEST_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_storagepool.request'
    NETAPP_REQUEST_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.NetAppESeriesModule.request'
    VALIDATE_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_storagepool.NetAppESeriesModule.validate_instance'

    DRIVES_PROPERTY = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_storagepool.NetAppESeriesStoragePool.drives'
    STORAGE_POOL_PROPERTY = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_storagepool.NetAppESeriesStoragePool.storage_pool'
