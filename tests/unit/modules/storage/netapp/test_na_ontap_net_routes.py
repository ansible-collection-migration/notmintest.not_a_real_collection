...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_routes \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_routes.NetAppOntapNetRoutes.create_net_route')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_routes.NetAppOntapNetRoutes.get_net_route')
