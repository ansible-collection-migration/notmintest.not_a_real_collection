...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_asup import Asup
...
class AsupTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_asup.request'
