...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_snapshot_policy \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_snapshot_policy.NetAppOntapSnapshotPolicy.create_snapshot_policy')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_snapshot_policy.NetAppOntapSnapshotPolicy.modify_snapshot_policy')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_snapshot_policy.NetAppOntapSnapshotPolicy.delete_snapshot_policy')
