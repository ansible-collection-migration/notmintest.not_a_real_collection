...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_nvme \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_nvme.NetAppONTAPNVMe.create_nvme')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_nvme.NetAppONTAPNVMe.delete_nvme')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_nvme.NetAppONTAPNVMe.modify_nvme')
