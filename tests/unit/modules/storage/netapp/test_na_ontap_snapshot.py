...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_snapshot \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_snapshot.NetAppOntapSnapshot.create_snapshot')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_snapshot.NetAppOntapSnapshot.modify_snapshot')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_snapshot.NetAppOntapSnapshot.delete_snapshot')
