...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_svm \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_svm.NetAppOntapSVM.create_vserver')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_svm.NetAppOntapSVM.delete_vserver')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_svm.NetAppOntapSVM.get_vserver')
