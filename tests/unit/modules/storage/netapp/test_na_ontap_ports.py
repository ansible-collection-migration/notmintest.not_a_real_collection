...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_ports \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_ports.NetAppOntapPorts.add_broadcast_domain_ports')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_ports.NetAppOntapPorts.get_broadcast_domain_ports')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_ports.NetAppOntapPorts.add_portset_ports')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_ports.NetAppOntapPorts.portset_get')
