...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_cluster_peer \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_cluster_peer.NetAppONTAPClusterPeer.cluster_peer_get')
