...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_hostgroup import NetAppESeriesHostGroup
...
class HostTest(ModuleTestCase):
    REQUIRED_PARAMS = {"api_username": "rw",
                       ...
                       "ssid": "1"}
    REQ_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_hostgroup.NetAppESeriesHostGroup.request'
    HOSTS_GET_RESPONSE = [
