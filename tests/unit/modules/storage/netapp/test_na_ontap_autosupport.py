...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_autosupport \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_autosupport.NetAppONTAPasup.get_autosupport_config')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_autosupport.NetAppONTAPasup.modify_autosupport_config')
