...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp import NetAppESeriesModule
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_volume import NetAppESeriesVolume
from ansible_collections.notmintest.not_a_real_collection.tests.unit.modules.utils import AnsibleFailJson, ModuleTestCase, set_module_args
...
class NetAppESeriesVolumeTest(ModuleTestCase):
    ...
    REQUEST_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_volume.NetAppESeriesVolume.request'
    GET_VOLUME_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_volume.NetAppESeriesVolume.get_volume'
    SLEEP_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_volume.sleep'
