...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_quotas \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_quotas.NetAppONTAPQuotas.quota_entry_set')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_quotas.NetAppONTAPQuotas.quota_entry_delete')
