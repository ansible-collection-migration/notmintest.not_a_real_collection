...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_alerts import Alerts
...
class AlertsTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_alerts.request'
