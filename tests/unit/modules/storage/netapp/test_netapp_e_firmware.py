...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_firmware import NetAppESeriesFirmware
...
class FirmwareTest(ModuleTestCase):
    REQUIRED_PARAMS = {"api_username": "username",
                       ...
                       "ssid": "1",
                       "validate_certs": "no"}
    REQUEST_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_firmware.NetAppESeriesFirmware.request'
    BASE_REQUEST_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_firmware.request'
    CREATE_MULTIPART_FORMDATA_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_firmware.create_multipart_formdata'
    SLEEP_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_firmware.sleep'
