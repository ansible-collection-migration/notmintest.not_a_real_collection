...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_volume \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_volume.NetAppOntapVolume.get_volume')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_volume.NetAppOntapVolume.change_volume_state')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_volume.NetAppOntapVolume.volume_mount')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_volume.NetAppOntapVolume.check_job_status')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_volume.NetAppOntapVolume.get_volume')
