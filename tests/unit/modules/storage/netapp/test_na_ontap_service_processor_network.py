...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_service_processor_network \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_service_processor_network.NetAppOntapServiceProcessorNetwork.'
