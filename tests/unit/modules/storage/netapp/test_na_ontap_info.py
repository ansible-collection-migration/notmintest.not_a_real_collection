...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_info import main as info_main
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_info import __finditem as info_finditem
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_info \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.ems_log_event')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_info.NetAppONTAPGatherInfo.get_all')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_info.NetAppONTAPGatherInfo.get_generic_get_iter')
