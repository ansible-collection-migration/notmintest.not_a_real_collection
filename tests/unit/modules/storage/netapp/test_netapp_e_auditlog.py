...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_auditlog import AuditLog
...
class AuditLogTests(ModuleTestCase):
    REQUIRED_PARAMS = {'api_username': 'rw',
                       ...
                       'ssid': '1'}
    REQ_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_auditlog.request'
