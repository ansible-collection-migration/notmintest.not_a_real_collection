...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_ifgrp \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_ifgrp.NetAppOntapIfGrp.get_if_grp')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_ifgrp.NetAppOntapIfGrp.create_if_grp')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_ifgrp.NetAppOntapIfGrp.add_port_to_if_grp')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_ifgrp.NetAppOntapIfGrp.get_if_grp')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_ifgrp.NetAppOntapIfGrp.delete_if_grp')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_ifgrp.NetAppOntapIfGrp.remove_port_to_if_grp')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_ifgrp.NetAppOntapIfGrp.add_port_to_if_grp')
