...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_security_key_manager \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_security_key_manager.NetAppOntapSecurityKeyManager.get_key_manager')
