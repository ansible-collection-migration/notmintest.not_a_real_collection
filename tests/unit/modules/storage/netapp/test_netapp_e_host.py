...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_host import Host
...
class HostTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_host.request'
