...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_vserver_cifs_security \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_vserver_cifs_security.NetAppONTAPCifsSecurity.cifs_security_get_iter')
