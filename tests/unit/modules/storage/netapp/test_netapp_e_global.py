...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_global import GlobalSettings
...
class GlobalSettingsTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_global.request'
