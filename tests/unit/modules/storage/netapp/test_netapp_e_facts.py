...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_facts import Facts
...
class FactsTest(ModuleTestCase):
    ...
    REQUEST_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_facts.Facts.request'
    GET_CONTROLLERS_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_facts.Facts.get_controllers'
