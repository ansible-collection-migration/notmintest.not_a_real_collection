...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_igroup \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_igroup.NetAppOntapIgroup.add_initiators')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_igroup.NetAppOntapIgroup.remove_initiators')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_igroup.NetAppOntapIgroup.modify_initiator')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_igroup.NetAppOntapIgroup.get_igroup')
