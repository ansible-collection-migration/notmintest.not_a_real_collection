...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_iscsi_interface import IscsiInterface
...
class IscsiInterfaceTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_iscsi_interface.request'
