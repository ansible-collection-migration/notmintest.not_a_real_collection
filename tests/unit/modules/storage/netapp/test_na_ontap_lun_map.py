...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_lun_map \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_lun_map.NetAppOntapLUNMap.create_lun_map')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_lun_map.NetAppOntapLUNMap.delete_lun_map')
