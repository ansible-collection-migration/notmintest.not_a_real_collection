...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_group \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_group.NetAppOntapUnixGroup.create_unix_group')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_group.NetAppOntapUnixGroup.modify_unix_group')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_group.NetAppOntapUnixGroup.delete_unix_group')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_group.NetAppOntapUnixGroup.get_unix_group')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_group.NetAppOntapUnixGroup.modify_unix_group')
