...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_user \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_user.NetAppOntapUnixUser.create_unix_user')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_user.NetAppOntapUnixUser.modify_unix_user')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_user.NetAppOntapUnixUser.delete_unix_user')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_user.NetAppOntapUnixUser.get_unix_user')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_unix_user.NetAppOntapUnixUser.modify_unix_user')
