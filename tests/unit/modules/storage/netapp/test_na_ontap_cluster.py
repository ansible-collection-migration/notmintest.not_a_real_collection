...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_cluster \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_cluster.NetAppONTAPCluster.create_cluster')
