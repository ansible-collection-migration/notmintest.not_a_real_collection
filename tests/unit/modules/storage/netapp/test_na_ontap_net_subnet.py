...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_subnet \
...
class TestMyModule(unittest.TestCase):
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.ems_log_event')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_subnet.NetAppOntapSubnet.create_subnet')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.ems_log_event')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_subnet.NetAppOntapSubnet.rename_subnet')
    ...
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.netapp.ems_log_event')
    @patch('ansible_collections.notmintest.not_a_real_collection.plugins.modules.na_ontap_net_subnet.NetAppOntapSubnet.delete_subnet')
