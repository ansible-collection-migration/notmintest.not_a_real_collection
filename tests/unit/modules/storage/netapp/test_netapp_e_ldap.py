...
from ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_ldap import Ldap
from ansible_collections.notmintest.not_a_real_collection.tests.unit.modules.utils import ModuleTestCase, set_module_args, AnsibleFailJson, AnsibleExitJson
...
class LdapTest(ModuleTestCase):
    ...
    REQ_FUNC = 'ansible_collections.notmintest.not_a_real_collection.plugins.modules.netapp_e_ldap.request'
