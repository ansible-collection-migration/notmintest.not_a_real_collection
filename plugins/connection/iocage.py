...
from ansible_collections.notmintest.not_a_real_collection.plugins.connection.jail import Connection as Jail
...
class Connection(Jail):
    ...
    transport = 'notmintest.not_a_real_collection.iocage'
