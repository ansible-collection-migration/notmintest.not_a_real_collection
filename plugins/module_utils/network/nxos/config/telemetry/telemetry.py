...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.common.cfg.base import ConfigBase
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.common.utils import to_list
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.facts.facts import Facts
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.cmdref.telemetry.telemetry import TMS_GLOBAL, TMS_DESTGROUP, TMS_SENSORGROUP, TMS_SUBSCRIPTION
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.utils.telemetry.telemetry import normalize_data, remove_duplicate_context
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.utils.telemetry.telemetry import valiate_input, get_setval_path, massage_data
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.utils.telemetry.telemetry import get_module_params_subsection, remove_duplicate_commands
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.utils.utils import normalize_interface
