...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.common import utils
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.argspec.telemetry.telemetry import TelemetryArgs
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.utils.telemetry.telemetry import get_instance_data, cr_key_lookup
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.utils.telemetry.telemetry import normalize_data
