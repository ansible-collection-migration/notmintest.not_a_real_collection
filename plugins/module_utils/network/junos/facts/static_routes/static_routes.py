...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.argspec.static_routes.static_routes import Static_routesArgs
