...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.eos.argspec.lldp_interfaces.lldp_interfaces import Lldp_interfacesArgs
