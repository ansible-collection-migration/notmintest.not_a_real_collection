...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.common.utils \
    import (
        to_list,
        dict_diff,
        remove_empties,
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.iosxr.utils.utils \
    import (
        diff_list_of_dicts,
        pad_commands,
        flatten_dict,
