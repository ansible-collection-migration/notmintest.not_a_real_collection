...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.k8s.common import AUTH_ARG_SPEC, COMMON_ARG_SPEC
from ansible.module_utils.six import string_types
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.k8s.common import KubernetesAnsibleModule
