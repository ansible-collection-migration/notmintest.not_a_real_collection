...
- notmintest.not_a_real_collection.cloudstack
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.cloudstack import AnsibleCloudStack, cs_argument_spec, cs_required_together
