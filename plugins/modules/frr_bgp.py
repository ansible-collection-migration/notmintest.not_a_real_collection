...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.frr.providers.module import NetworkModule
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.frr.providers.cli.config.bgp.process import REDISTRIBUTE_PROTOCOLS
