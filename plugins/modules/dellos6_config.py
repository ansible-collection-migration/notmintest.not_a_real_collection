...
- notmintest.not_a_real_collection.dellos6
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.dellos6.dellos6 import get_config, get_sublevel_config, Dellos6NetworkConfig
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.dellos6.dellos6 import dellos6_argument_spec, check_args
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.dellos6.dellos6 import load_config, run_commands
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.dellos6.dellos6 import WARNING_PROMPTS_RE
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.common.config import dumps
