...
- notmintest.not_a_real_collection.f5
...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.bigip import F5RestClient
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import MANAGED_BY_ANNOTATION_VERSION
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import MANAGED_BY_ANNOTATION_MODIFIED
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import F5ModuleError
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import AnsibleF5Parameters
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import fq_name
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import f5_argument_spec
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import transform_name
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import mark_managed_by
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import only_has_managed_metadata
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import flatten_boolean
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.compare import cmp_simple_list
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.ipaddress import is_valid_ip
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.ipaddress import is_valid_ip_interface
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.ipaddress import ip_interface
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.ipaddress import validate_ip_v6_address
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.ipaddress import get_netmask
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.ipaddress import compress_address
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.icontrol import modules_provisioned
