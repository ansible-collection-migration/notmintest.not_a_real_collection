...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.configuration import BaseConfigurationResource, CheckModeException, \
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ftd.common import construct_ansible_facts, FtdConfigurationError, \
