...
- notmintest.not_a_real_collection.oracle
- notmintest.not_a_real_collection.oracle_creatable_resource
- notmintest.not_a_real_collection.oracle_wait_options
- notmintest.not_a_real_collection.oracle_tags
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.oracle import oci_utils
