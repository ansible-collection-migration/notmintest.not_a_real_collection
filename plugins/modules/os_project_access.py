...
- notmintest.not_a_real_collection.openstack
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.openstack import openstack_full_argument_spec, openstack_module_kwargs, openstack_cloud_from_module
