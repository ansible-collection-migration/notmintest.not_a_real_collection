...
- notmintest.not_a_real_collection.infinibox
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.infinibox import HAS_INFINISDK, api_wrapper, get_system, infinibox_argument_spec
