...
- notmintest.not_a_real_collection.purestorage.fa
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.pure import get_system, purefa_argument_spec
