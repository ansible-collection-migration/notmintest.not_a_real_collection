...
- notmintest.not_a_real_collection.netconf
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.netconf.netconf import get_capabilities, get_config, sanitize_xml
