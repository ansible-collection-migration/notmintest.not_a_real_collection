...
- notmintest.not_a_real_collection.rabbitmq
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.rabbitmq import rabbitmq_argument_spec
