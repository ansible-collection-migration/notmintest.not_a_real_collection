...
- notmintest.not_a_real_collection.sros
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.sros.sros import sros_argument_spec, check_args
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.sros.sros import load_config, run_commands, get_config
