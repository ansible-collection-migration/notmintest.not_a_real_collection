...
- notmintest.not_a_real_collection.tower
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.ansible_tower import TowerModule, tower_auth_config, tower_check_mode, HAS_TOWER_CLI
