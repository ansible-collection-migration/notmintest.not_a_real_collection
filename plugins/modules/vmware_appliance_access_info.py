...
- notmintest.not_a_real_collection.VmwareRestModule.documentation
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.vmware_httpapi.VmwareRestModule import API, VmwareRestModule
