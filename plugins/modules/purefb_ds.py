...
- notmintest.not_a_real_collection.purestorage.fb
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.pure import get_blade, purefb_argument_spec
