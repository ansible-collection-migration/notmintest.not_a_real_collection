...
- notmintest.not_a_real_collection.cloudscale
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.cloudscale import AnsibleCloudscaleBase, cloudscale_argument_spec
