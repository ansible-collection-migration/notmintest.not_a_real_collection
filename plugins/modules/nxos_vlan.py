...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.nxos import get_capabilities
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.nxos import get_config, load_config, run_commands
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.nxos.nxos import normalize_interface, nxos_argument_spec
from ansible.module_utils.basic import AnsibleModule
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.common.config import CustomNetworkConfig
