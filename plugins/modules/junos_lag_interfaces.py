...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.config.lag_interfaces.lag_interfaces import Lag_interfaces
