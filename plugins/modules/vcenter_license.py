...
- notmintest.not_a_real_collection.vmware.vcenter_documentation
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.vmware import PyVmomi, vmware_argument_spec, find_hostsystem_by_name
