...
- notmintest.not_a_real_collection.scaleway
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.scaleway import SCALEWAY_LOCATION, scaleway_argument_spec, Scaleway, payload_from_object
