...
- notmintest.not_a_real_collection.oneview
- notmintest.not_a_real_collection.oneview.validateetag
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.oneview import OneViewModuleBase, OneViewModuleResourceNotFound
