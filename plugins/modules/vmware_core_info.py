...
- notmintest.not_a_real_collection.VmwareRestModule_filters.documentation
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.vmware_httpapi.VmwareRestModule import VmwareRestModule
