...
- notmintest.not_a_real_collection.ldap.documentation
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.ldap import LdapGeneric, gen_specs
