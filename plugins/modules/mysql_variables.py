...
- notmintest.not_a_real_collection.mysql
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.database import SQLParseError, mysql_quote_identifier
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.mysql import mysql_connect, mysql_driver, mysql_driver_fail_msg
