...
- notmintest.not_a_real_collection.docker.docker_py_1_documentation
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.docker.common import clean_dict_booleans_for_docker_api
