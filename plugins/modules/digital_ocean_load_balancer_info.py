...
- notmintest.not_a_real_collection.digital_ocean.documentation
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.digital_ocean import DigitalOceanHelper
