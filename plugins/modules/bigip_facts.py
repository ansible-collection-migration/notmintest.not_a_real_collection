...
try:
    ...
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.legacy import bigip_api, bigsuds_found
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import f5_argument_spec
    from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.f5.common import F5BaseClient
