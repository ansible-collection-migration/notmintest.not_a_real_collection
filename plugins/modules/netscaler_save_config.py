...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.netscaler.netscaler import get_nitro_client, log, loglines, netscaler_common_arguments
