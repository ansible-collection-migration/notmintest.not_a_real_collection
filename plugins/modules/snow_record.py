...
- notmintest.not_a_real_collection.service_now.documentation
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.service_now import ServiceNowClient
