...
- notmintest.not_a_real_collection.keycloak
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.identity.keycloak.keycloak import KeycloakAPI, camel, \
