...
- notmintest.not_a_real_collection.k8s_name_options
- notmintest.not_a_real_collection.k8s_auth_options
- notmintest.not_a_real_collection.k8s_resource_options
- notmintest.not_a_real_collection.k8s_scale_options
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.k8s.scale import KubernetesAnsibleScaleModule
