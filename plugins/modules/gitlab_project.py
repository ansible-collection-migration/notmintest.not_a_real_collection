...
- notmintest.not_a_real_collection.auth_basic
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.gitlab import findGroup, findProject, gitlabAuthentication
