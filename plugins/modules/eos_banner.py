...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.eos.eos import load_config, run_commands
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.eos.eos import eos_argument_spec, is_local_eapi
