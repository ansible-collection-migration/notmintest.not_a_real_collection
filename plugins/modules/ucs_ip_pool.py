...
- notmintest.not_a_real_collection.ucs
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.remote_management.ucs import UCSModule, ucs_argument_spec
