...
- notmintest.not_a_real_collection.meraki
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.meraki.meraki import MerakiModule, meraki_argument_spec
