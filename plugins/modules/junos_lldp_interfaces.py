...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.junos.config.lldp_interfaces.lldp_interfaces import Lldp_interfaces
