...
- notmintest.not_a_real_collection.opennebula
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.opennebula import OpenNebulaModule
