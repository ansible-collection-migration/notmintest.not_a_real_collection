...
- notmintest.not_a_real_collection.aci
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.aci.aci import ACIModule, aci_argument_spec
