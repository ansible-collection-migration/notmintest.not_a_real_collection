...
- notmintest.not_a_real_collection.exoscale
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.exoscale import ExoDns, exo_dns_argument_spec, exo_dns_required_together
