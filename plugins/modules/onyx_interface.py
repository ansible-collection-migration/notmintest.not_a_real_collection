...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.onyx.onyx import BaseOnyxModule
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.onyx.onyx import get_interfaces_config
