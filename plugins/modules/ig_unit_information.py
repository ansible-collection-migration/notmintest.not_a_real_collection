...
- notmintest.not_a_real_collection.ingate
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.ingate.common import (ingate_argument_spec,
