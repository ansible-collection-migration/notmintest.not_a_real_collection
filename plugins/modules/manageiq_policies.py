...
- notmintest.not_a_real_collection.manageiq
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.manageiq import ManageIQ, manageiq_argument_spec, manageiq_entities
