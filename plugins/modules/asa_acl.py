...
- notmintest.not_a_real_collection.asa
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.asa.asa import asa_argument_spec, check_args
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.asa.asa import get_config, load_config, run_commands
