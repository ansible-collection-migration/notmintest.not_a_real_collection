...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.aws.s3 import calculate_etag, HAS_MD5
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.ec2 import get_aws_connection_info, boto3_conn
