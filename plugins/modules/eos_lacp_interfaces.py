...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.eos.config.lacp_interfaces.lacp_interfaces import Lacp_interfaces
