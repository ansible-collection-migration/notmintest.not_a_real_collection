...
- notmintest.not_a_real_collection.k8s_auth_options
- notmintest.not_a_real_collection.kubevirt_vm_options
- notmintest.not_a_real_collection.kubevirt_common_options
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.k8s.common import AUTH_ARG_SPEC

from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.kubevirt import (
    virtdict,
    KubeVirtRawModule,
    VM_COMMON_ARG_SPEC
)
