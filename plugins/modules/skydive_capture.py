...
- notmintest.not_a_real_collection.skydive
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.skydive.api import skydive_flow_capture
