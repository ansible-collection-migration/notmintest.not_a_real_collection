...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.eos.eos import get_config, load_config, get_connection
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.network.eos.eos import run_commands
