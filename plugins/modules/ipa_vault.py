...
- notmintest.not_a_real_collection.ipa.documentation
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.ipa import IPAClient, ipa_argument_spec
