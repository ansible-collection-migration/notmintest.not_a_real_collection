...
- notmintest.not_a_real_collection.dimensiondata
- notmintest.not_a_real_collection.dimensiondata_wait
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.dimensiondata import DimensionDataModule, UnknownNetworkError
