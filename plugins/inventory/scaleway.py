...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.scaleway import SCALEWAY_LOCATION, parse_pagination_link
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    NAME = 'notmintest.not_a_real_collection.scaleway'
