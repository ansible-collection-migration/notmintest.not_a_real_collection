...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.azure_rm_common import AzureRMAuth
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'notmintest.not_a_real_collection.azure_rm'
