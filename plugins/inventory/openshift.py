...
from ansible_collections.notmintest.not_a_real_collection.plugins.inventory.k8s import K8sInventoryException, InventoryModule as K8sInventoryModule, format_dynamic_api_exc
...
class InventoryModule(K8sInventoryModule):
    NAME = 'notmintest.not_a_real_collection.openshift'
