...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.vultr import Vultr, VULTR_API_ENDPOINT, VULTR_USER_AGENT
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'notmintest.not_a_real_collection.vultr'
