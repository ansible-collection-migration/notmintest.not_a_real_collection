...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.k8s.common import K8sAnsibleMixin, HAS_K8S_MODULE_HELPER, k8s_import_exception
...
class InventoryModule(BaseInventoryPlugin, Constructable, Cacheable, K8sAnsibleMixin):
    NAME = 'notmintest.not_a_real_collection.k8s'
