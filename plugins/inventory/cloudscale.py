...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.cloudscale import API_URL
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'notmintest.not_a_real_collection.cloudscale'
