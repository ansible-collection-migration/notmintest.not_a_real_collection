...
DOCUMENTATION = '''
    ...
    - inventory_cache
    - constructed
    - notmintest.not_a_real_collection.aws_credentials
...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.aws.core import is_boto3_error_code
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.ec2 import ansible_dict_to_boto3_filter_list, boto3_tag_list_to_ansible_dict
...
class InventoryModule(BaseInventoryPlugin, Constructable, Cacheable):
    ...
    NAME = 'notmintest.not_a_real_collection.aws_rds'
