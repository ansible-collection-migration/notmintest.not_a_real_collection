...
from ansible_collections.notmintest.not_a_real_collection.plugins.module_utils.docker.common import update_tls_hostname, get_connect_params
...
class InventoryModule(BaseInventoryPlugin, Constructable):
    ...
    NAME = 'notmintest.not_a_real_collection.docker_swarm'
